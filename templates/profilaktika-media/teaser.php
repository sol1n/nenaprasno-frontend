            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <div class="launch-teaser-logo">
                        <img src="../../public/assets/images/profilaktika-media/logo.svg" alt="Profilactika Media — Ненапрасно">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6">
                    <div class="launch-teaser-text">
                        ...
                        <p>
                            Мы начнем рассказывать о важном <a href="#">4&nbsp;февраля</a>,
                            во Всемирный день борьбы против рака.
                        </p>
                    </div>
                </div>
            </div>

            <form action="#" class="launch-teaser-form">
